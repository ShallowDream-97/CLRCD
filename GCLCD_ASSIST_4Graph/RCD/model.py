...
class Net(nn.Module):
    def __init__(self, args, local_map):
        ...
        #self.directed_g = remove_random_edges(local_map['directed_g'],0.05).to(self.device)
    ...
    def forward(self, stu_id, exer_id, kn_r,all_stu_emb):
        all_stu_emb = all_stu_emb.to(self.device)
