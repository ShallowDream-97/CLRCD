...
def train(args, local_map):
    ...
    net = net.to(device)
    net.load_state_dict(torch.load('/home/tmp/GCLCD_GCN/RCD/model/model_epoch1_dropout:0.05_ssl_para:1e-07_reg_para:-1e-07'))
    grapheva.load_state_dict(torch.load('/home/tmp/GCLCD_GCN/RCD/model/graph_model_epoch1_dropout:0.05_ssl_para:1e-07_reg_para:-1e-07'))
