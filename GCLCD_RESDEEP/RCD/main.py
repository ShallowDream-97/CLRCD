...
def train(args, local_map):
    ...
    net = net.to(device)
    net.load_state_dict(torch.load('/home/tmp/CLRCD_GraphInde/RCD/model/model_pre'))
    ...
    for epoch in (range(args.epoch_n)):
        ...
        while not data_loader.is_end():
            ...
            output_1 = net.forward(input_stu_ids, input_exer_ids, input_knowledge_embs,all_stu_emb_ssl)
        ...
        save_snapshot(grapheva, 'model/graph_model_epoch' + str(epoch + 1)+ '_dropout:'+str(args.dropout)+'_ssl_para:'+str(args.ssl_para)+'_reg_para:'+str(args.reg_para))
